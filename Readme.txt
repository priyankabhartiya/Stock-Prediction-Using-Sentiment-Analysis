...
1) Open Anaconda Prompt 
	...
	Now for Reddit News Dataset follow follo commands
		cd Reddit News
		python ml_models_Reddit.py
	For Top 25 Nes Headline Dataset
		cd "Top 25 Headlines"
		python ml_models_DJIA.py
2) If you have chosen to install python (and did not set up PATH variable for it) then follow below instructions:
...
3) Sentiment Analysis will take few minutes to execute, so all in all programs for both dataset will take few minutes for excution and once the execution is complete final error matrix will be promted on the screen as a final result.
